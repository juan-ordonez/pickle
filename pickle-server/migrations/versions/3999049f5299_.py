...
Revision ID: 3999049f5299
Revises: 17e88d0195fb
Create Date: 2017-11-20 01:22:05.924136
...
revision = '3999049f5299'
down_revision = '17e88d0195fb'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.drop_table('auth_comment')
    op.drop_table('session_table')
    op.drop_table('auth_user')
    op.drop_table('browsing_table')
    op.drop_table('auth_url')
    op.drop_table('auth_notification')
...
def downgrade():
    ...
    sa.Column('time', mysql.VARCHAR(length=512), nullable=True),
    sa.Column('user_id', mysql.VARCHAR(length=128), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], [u'auth_user.id'], name=u'auth_url_ibfk_1'),
    sa.PrimaryKeyConstraint('id'),
    mysql_default_charset=u'utf8',
    mysql_engine=u'InnoDB'
    )
