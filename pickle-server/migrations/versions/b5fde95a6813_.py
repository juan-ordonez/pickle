...
Revision ID: b5fde95a6813
Revises: 95ecb00fe047
Create Date: 2018-01-02 18:41:13.851346
...
revision = 'b5fde95a6813'
down_revision = '95ecb00fe047'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('auth_feed', sa.Column('group_id', mysql.VARCHAR(length=128), nullable=True))
