...
Revision ID: 34d77cb0f466
Revises: b5fde95a6813
Create Date: 2018-01-06 13:42:05.773859
...
revision = '34d77cb0f466'
down_revision = 'b5fde95a6813'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('auth_group', sa.Column('direct', mysql.TINYINT(display_width=1), autoincrement=False, nullable=True))
